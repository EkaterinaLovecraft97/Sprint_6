...
@allure.epic("Тестирование логотипов")  # Объединяем тесты в эпик
class TestLogoRedirect:
    ...
    def test_logo_scooter_redirect_to_home(self, order_page):
    ...
    def test_logo_yandex_redirect_to_dzen(self, order_page):
